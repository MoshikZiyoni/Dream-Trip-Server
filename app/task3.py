...
(list1)=['Coimbra','Murchison Falls National Park', 'Ankara', 'Drammen', 'Oruro', 'Belo Horizonte', 'Eindhoven', 'Oulu', 'Daegu', 'Potosi', 'Gaziantep', 'Santo Domingo', 'Tampere', 'Mombasa', 'Gran Canaria', 'Adana', 'Antalya', 'Budva', 'Nizhny Novgorod', 'Gdansk', 'Ushuaia', 'Saint Petersburg', 'Patras', 'Fortaleza', 'Tilburg', 'Poznan', 'Shenzhen', 'Samara', 'Cali']
(list2)=['Encarnacion', 'Heraklion', 'Ostrava', 'Escaldes-Engordany', 'Glasgow', 'Medellin', 'Kazan', 'Buzios', 'Waterford', 'El Calafate', 'Szczecin', 'Montevideo', 'Corfu', 'Tlemcen', 'Larissa', 'Funchal', 'Liverpool', 'Vantaa', 'Frankfurt', 'Ioannina', 'Boa Vista', 'Kampala', 'Stuttgart', 'Lausanne', 'Crete', 'Incheon', 'Konya', 'Punta del Este']
(list3)=['Gwangju', 'Shanghai', 'Bergen', 'Santa Marta', 'Florianopolis', 'Punta Cana', 'Maasai Mara', 'Daejeon', 'Geneva', 'Ciudad del Este', 'Sao Luis', 'Tianjin', 'Wroclaw', 'Belem', 'Bursa', 'Tenerife', 'Oran', 'Ulsan', 'Mexico city', 'Novosibirsk', 'Porto Seguro', 'Krakow', 'Ayers Rock (Uluru)', 'Montego Bay', 'Basel', 'Birmingham', 'Izmir', 'Palma de Mallorca']
(list4)=['Liberec','Natal', 'Braga', 'Entebbe', 'Lodz', 'Espoo', 'Lucerne', 'Brasilia', 'Puerto Natales', 'Volos', 'Joao Pessoa', 'San Juan', 'Dubrovnik', 'Puebla City', 'Vlore', 'Foz do Iguacu', 'Lake Titicaca', 'St. Gallen', 'Salta', 'Khuvsgul Lake', 'Busan', 'Kotor', 'Stavanger', 'Fredrikstad', 'Curitiba', 'Leeds', 'Thessaloniki', 'Monterrey', 'Colonia']
(list5)=[  'Amadora', 'Trondheim', 'Hangzhou', 'Cayo Coco', 'Chengdu', 'Chelyabinsk', 'Maceio', 'Asuncion', 'Bern', 'Guangzhou', 'Valparaiso', 'Porto Alegre', 'Tijuana', 'Rhodes', 'Wuhan', 'Leipzig', 'Düsseldorf', 'Hradec Kralove', 'Plzen', 'Zurich', 'Yekaterinburg', 'Sandnes', 'Leticia', 'Amalfi Coast', 'La Massana', 'Samui', 'Mykonos', 'Turku', 'Vila Nova de Gaia']
print (len(list1))
print (len(list2))
print (len(list3))
print (len(list4))
