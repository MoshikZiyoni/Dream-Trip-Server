...
attractions_list1 = [  'Olomouc', 'Sapporo',  'Miami', 'Santiago', 'Prague', 'Beirut', 'Budapest', 'Saranda', 'Sintra', 'Lahti', 'The Hague',  'Wellington', 'Manila',     'Edinburgh',  'Vasteras', 'Dubai',    'Boquete',  'Pecs', 'San Francisco',   'Berat', 'Munich',  'Seattle']
